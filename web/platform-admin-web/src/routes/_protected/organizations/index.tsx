...
function OrganizationsPage() {
  ...
  return (
    <div className="size-full mx-auto flex max-w-300 min-h-0 flex-col gap-6 overflow-hidden p-6">
      ...
      <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as OrganizationTab)} className="flex flex-1 min-h-0 flex-col gap-4 overflow-hidden">
        ...
        <TabsContent value="overview" className="mt-0 flex flex-1 min-h-0 flex-col overflow-hidden">
          <OrganizationOverviewTab organization={MOCK_ORGANIZATION} />
        </TabsContent>

        <TabsContent value="activity" className="mt-0 flex flex-1 min-h-0 flex-col overflow-hidden">
