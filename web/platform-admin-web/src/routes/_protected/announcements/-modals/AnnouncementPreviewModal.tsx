            ...
            <section className="space-y-4 rounded-xl border border-slate-200 bg-slate-50/70 p-4">
              <div className="space-y-2">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <Badge variant="secondary" className="rounded-full border-slate-200 bg-white px-2.5 py-1 text-[11px] text-slate-700">
              ...
              <div className="space-y-3 border-t border-slate-200 pt-3 text-sm text-slate-600">
                <div className="space-y-1">
                  <div className="text-[11px] uppercase tracking-[0.2em] text-slate-400">대상</div>
