...
export class MailService {
  ...
  async sendInviteEmail(
    ...
    const acceptLink = `${ENV.CLIENT_URL}/invite?token=${token}`;
    ...
    const html = `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 8px;">
        ...
        <p style="color: #666; font-size: 14px;">본 링크는 ${ENV.MEMBER_INVITE_EXPIRY_DAYS}일간 유효합니다. 만약 본인이 요청하지 않은 경우, 이 메일을 무시하셔도 됩니다.</p>
