...
export class GetSignupTermListItem {
  constructor(args: GetSignupTermListItem) {
...
export class GetSignupTermListResponseDto extends ListResponseDto<GetSignupTermListItem> {
  constructor(args: GetSignupTermListResponseDto) {
    super();
    this.items = args.items;
  }

  @ApiProperty({ type: () => [GetSignupTermListItem], description: '회원가입용 플랫폼 약관 목록' })
