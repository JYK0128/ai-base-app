...
export class ChangePasswordRequestDto extends PayloadRequestDto {
  @ApiProperty({ example: 'CurrentPassword123!', type: String, description: '현재 비밀번호' })
  @Type(() => String)
  @IsNotEmptyString({ message: '현재 비밀번호는 필수 입력 항목입니다.' })
  currentPassword!: string;

  @ApiProperty({ example: 'NewPassword123!', type: String, description: '새 비밀번호' })
  @Type(() => String)
  ...
  @ApiProperty({ example: 'NewPassword123!', type: String, description: '새 비밀번호 확인' })
  @Type(() => String)
